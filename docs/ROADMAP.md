...
| Шаг | Описание | Статус |
|-----|----------|--------|
| 7.1 | Визуальная иерархия: типографика, отступы, читаемость карточек | todo |
| 7.2 | Навигация: фильтр/поиск по фотографу и дате, быстрые действия | todo |
| 7.3 | Мобильный сценарий: адаптив для телефона и планшета | todo |
| 7.4 | UX обработки пачек: явные состояния, прогресс, ошибки, подтверждения | todo |
| 7.5 | Мини-юзабилити тест с бильдами, фиксация обратной связи | todo |
| Док | [modules/07-ui-ux-bild.md](modules/07-ui-ux-bild.md) | todo |
